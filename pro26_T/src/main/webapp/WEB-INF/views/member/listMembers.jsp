...
<div align="center">
<form  method="get" action="${contextPath}/member/member.do?action=${value}">
<select name="action">
   ...
   <c:forEach var="member" items="${membersList}">
    <tr align="center">
     <td>${member.id}</td>
      ...
      <td><a href="${contextPath}/member/modMemberForm.do?id=${member.id}&pwd=${member.pwd}&name=${member.name}&email=${member.email}" >수정창나오기</a></td>
